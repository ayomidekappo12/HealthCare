    ...
    <div className="flex justify-between">
      ...
      <div className="flex flex-col items-start mt-4">
        <div className="flex items-center mb-2">
          ...
          <p className="font-Manrope font-bold text-[#072635] px-1">Systolic</p>
        </div>
        ...
        <div className="flex items-center mt-2">
          <Image
            ...
            height={6}
          />
          <p className="body-regular-14 font-Manrope text-right px-2">
            Higher than Average
          </p>
        </div>
        ...
        <div className="flex items-center mb-2">
          ...
          <p className="font-Manrope font-bold text-[#072635] px-1">
            Diastolic
          </p>
        </div>
